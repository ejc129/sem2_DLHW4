...
def extract_kart_objects(
    ...
    # Per assignment guidance: always use the kart closest to image center
    # as the ego kart, after filtering. Do NOT rely on track_id == 0.
    closest = min(
        kart_objects,
...
def generate_qa_pairs(info_path: str, view_index: int, img_width: int = 150, img_height: int = 100) -> list:
    ...
    # ------------------------------------------------------------------ #
    def classify_lr(cx):
        return "right" if cx >= img_cx else "left"
